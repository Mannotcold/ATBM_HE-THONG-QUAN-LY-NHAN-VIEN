...
namespace DA_ATBM
{
    public partial class TruongPhong : Form
    {
        ...
        private void button1_trpb_Click(object sender, EventArgs e)
        {
            Xemthongtincanhan();
        }
        ...
        private void button2_trpb_Click(object sender, EventArgs e)
        {
        ...
        private void button3_trpb_Click(object sender, EventArgs e)
        {
            Xemthongtinphongban();
        }
        ...
        private void button4_trpb_Click(object sender, EventArgs e)
        {
            Xemthongtindean();
        }
        ...
        private void button5_trpb_Click(object sender, EventArgs e)
        {
            Chinhsuangaysinhnv();
        }
        ...
        private void button6_trpb_Click(object sender, EventArgs e)
        {
            Chinhsuadiachinv();
        }
        ...
        private void button7_trpb_Click(object sender, EventArgs e)
        {
            Chinhsuasodtnv();
        }
        ...
        private void button8_trpb_Click(object sender, EventArgs e)
        {
        ...
        private void Xemdanhsachcacnhanvien()
        {
            ...
            cmd_cnv = new OracleCommand("SELECT * FROM QUANLY.NHANVIENPHONGBAN_V", con_ttcnv);
        ...
        private void button9_trpb_Click(object sender, EventArgs e)
        {
        ...
        private void Xemdanhsachcacnhanvienpc()
        {
            ...
            cmd_cnvpc = new OracleCommand("SELECT * FROM QUANLY.NHANVIENPBPHANCONG_V", con_ttcnvpc);
        ...
        private void button10_trpb_Click(object sender, EventArgs e)
        {
            insert_nhanvienpb();
        }
        ...
        private void insert_nhanvienpb()
        {
            OracleConnection con_pb = new OracleConnection();
            con_pb.ConnectionString = "Data Source=(DESCRIPTION =(ADDRESS = (PROTOCOL = TCP)(HOST = localhost)(PORT = 1521))(CONNECT_DATA =(SERVER = Oracle Man)(SERVICE_NAME = XE)));;User ID =" + TK + ";PASSWORD=" + MK + ";Connection Timeout=120;";
            DataSet dataSet_ds = new DataSet();
            con_pb.Open();
            OracleCommand cmd_inpb;
            OracleCommand cmd_commit;
            cmd_inpb = new OracleCommand("insert into quanly.NHANVIENPBPHANCONG_V values ('" +manv_trpb.Text.ToUpper() + "','" +madean_trpb.Text.ToUpper() + "',date'" + thoigian_trpb.Text.ToUpper() + "')", con_pb);
            cmd_inpb.CommandType = CommandType.Text;
            cmd_commit = new OracleCommand("commit", con_pb);
            cmd_commit.CommandType = CommandType.Text;
            cmd_inpb.ExecuteNonQuery();
            MessageBox.Show("INSERT thành công");
            con_pb.Close();
        }

        private void button11_trpb_Click(object sender, EventArgs e)
        {
            update_nhanvienpb();
        }
        ...
        private void update_nhanvienpb()
        {
            OracleConnection con_pb = new OracleConnection();
            con_pb.ConnectionString = "Data Source=(DESCRIPTION =(ADDRESS = (PROTOCOL = TCP)(HOST = localhost)(PORT = 1521))(CONNECT_DATA =(SERVER = Oracle Man)(SERVICE_NAME = XE)));;User ID =" + TK + ";PASSWORD=" + MK + ";Connection Timeout=120;";
            DataSet dataSet_ds = new DataSet();
            ...
            OracleCommand cmd_inpb;
            OracleCommand cmd_commit;
            if(madean_trpb.Text.ToUpper() != "" && thoigian_trpb.Text.ToUpper() == "")
            {
                cmd_inpb = new OracleCommand("update quanly.NHANVIENPBPHANCONG_V set mada = '"+ madean_trpb.Text.ToUpper() +"' where manv = '"+ manv_trpb.Text.ToUpper() +"'", con_pb);
                cmd_inpb.CommandType = CommandType.Text;
                cmd_commit = new OracleCommand("commit", con_pb);
                cmd_commit.CommandType = CommandType.Text;
                cmd_inpb.ExecuteNonQuery();
                MessageBox.Show("update madean thành công");
            }    
            if(thoigian_trpb.Text.ToUpper() != "" && madean_trpb.Text.ToUpper() == "")
            {
                cmd_inpb = new OracleCommand("update quanly.NHANVIENPBPHANCONG_V set thoigian = date'" + thoigian_trpb.Text.ToUpper() + "' where manv = '" + manv_trpb.Text.ToUpper() + "'", con_pb);
                cmd_inpb.CommandType = CommandType.Text;
                cmd_commit = new OracleCommand("commit", con_pb);
                cmd_commit.CommandType = CommandType.Text;
                cmd_inpb.ExecuteNonQuery();
                MessageBox.Show("update thoigian thành công");
            }    
            if(madean_trpb.Text.ToUpper() != "" && thoigian_trpb.Text.ToUpper() != "")
            {
                cmd_inpb = new OracleCommand("update quanly.NHANVIENPBPHANCONG_V set thoigian = date'" + thoigian_trpb.Text.ToUpper() +"',mada = '"+ madean_trpb.Text.ToUpper() + "' where manv = '" + manv_trpb.Text.ToUpper() + "'", con_pb);
                cmd_inpb.CommandType = CommandType.Text;
                cmd_commit = new OracleCommand("commit", con_pb);
                cmd_commit.CommandType = CommandType.Text;
                cmd_inpb.ExecuteNonQuery();
                MessageBox.Show("update madean và thoigian thành công");
            }    
            con_pb.Close();
        }

        private void button12_trpb_Click(object sender, EventArgs e)
        {
            delete_nhanvienpb();
        }

        private void delete_nhanvienpb() 
        {
            OracleConnection con_pb = new OracleConnection();
            con_pb.ConnectionString = "Data Source=(DESCRIPTION =(ADDRESS = (PROTOCOL = TCP)(HOST = localhost)(PORT = 1521))(CONNECT_DATA =(SERVER = Oracle Man)(SERVICE_NAME = XE)));;User ID =" + TK + ";PASSWORD=" + MK + ";Connection Timeout=120;";
            DataSet dataSet_ds = new DataSet();
            ...
            OracleCommand cmd_inpb;
            OracleCommand cmd_commit;
            cmd_inpb = new OracleCommand("delete from quanly.NHANVIENPBPHANCONG_V where manv = '"+manv_trpb+"'", con_pb);
            cmd_inpb.CommandType = CommandType.Text;
            cmd_commit = new OracleCommand("commit", con_pb);
            cmd_commit.CommandType = CommandType.Text;
            cmd_inpb.ExecuteNonQuery();
